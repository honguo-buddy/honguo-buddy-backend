...
class User(Base):
    ...
    avatar_attachment = relationship("Attachment", foreign_keys=[avatar_id])
    chat_sessions_as_user_one = relationship("ChatSession", foreign_keys="ChatSession.user_one_id", overlaps="user_one")
    chat_sessions_as_user_two = relationship("ChatSession", foreign_keys="ChatSession.user_two_id", overlaps="user_two")
    chat_messages_sent = relationship("ChatMessage", foreign_keys="ChatMessage.sender_id", overlaps="sender")
